...
// Integration tests for wincredManager
// Run with: go test -tags=integration ./internal/credentials/...

func TestWincredManagerAWSIntegration(t *testing.T) {
	mgr, err := newWincredManager()
	if err != nil {
		t.Fatalf("failed to create wincred manager: %v", err)
	}
...
func TestWincredManagerHetznerIntegration(t *testing.T) {
	mgr, err := newWincredManager()
	if err != nil {
		t.Fatalf("failed to create wincred manager: %v", err)
	}
...
func TestWincredManagerHasCredentialsUnknownProvider(t *testing.T) {
	mgr, err := newWincredManager()
	if err != nil {
		t.Fatalf("failed to create wincred manager: %v", err)
	}
